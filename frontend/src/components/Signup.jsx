import { Icon, icons, UserPlus } from "lucide-react";
import { useState } from "react";
import {BUTTONCLASSES, FIELDS, Inputwrapper, INPUTWRAPPER, MESSAGE_ERROR, MESSAGE_SUCCESS} from '../assets/dummy'
...
function Signup({onSwitchMode}){
    ...
    const handleSubmit = async(e)=>{
        ...
        try{
            const data=await axios.post(`${API_URL}/v1/auth/register`,formData)
    ...
    return (
        <div className="max-w-md w-full bg-white shadow-lg border border-purple-100 rounded-xl p-8">
            <div className="mb-6 text-center">
                ...
                <p className="text-gray-500 text-sm mt-1">Join TaskFlow to manage your task</p>
            ...
            {FIELDS.map(({ name, type, placeholder, icon: Icon }) => (
                ...
                <button 
                    ...
                    disabled={loading}>
                        {loading ? "Signing Up..." : <><UserPlus className="w-4 h-4"/>SignUp</> }
                </button>
            </form>
